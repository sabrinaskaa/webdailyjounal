        ...
        ?>
            <tr>
                ...
                <td>
                    <?php
                    if ($row["photo"] != '') {
                        if (file_exists('assets/images/' . $row["photo"])) {
                    ?>
                            <img src="assets/images/<?= $row["photo"] ?>" width="100">
                    <?php
                        }
                    }
                    ?>
                                ...
                                <form method="post" action="" enctype="multipart/form-data">
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" class="form-control" name="password" placeholder="Biarkan kosong untuk menyimpan kata sandi saat ini">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            if ($row["photo"] != '') {
                                                if (file_exists('assets/images/' . $row["photo"])) {
                                            ?>
                                                    <br><img src="assets/images/<?= $row["photo"] ?>" width="100">
                                            <?php
                                                } else {
                                                    // Jika file gambar tidak ditemukan di server
                                                    echo "<p class='text-danger'>Gambar tidak ditemukan.</p>";
                                                }
                                            } else {
                                                // Jika tidak ada gambar yang diunggah sebelumnya
                                                echo "<p class='text-secondary'>Tidak ada gambar yang diunggah sebelumnya.</p>";
                                            }
                                            ?>
